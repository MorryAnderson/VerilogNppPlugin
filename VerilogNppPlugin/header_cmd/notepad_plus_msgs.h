...
//Here you can find how to use these messages : https://github.com/notepad-plus-plus/npp-usermanual/blob/master/content/docs/plugin-communication.md
#define NPPMSG  (WM_USER + 1000)
    ...
    //void WM_PIMENU_CHECK(UINT	func_item[X]._cmdID, TRUE/FALSE)

	#define NPPM_ADDTOOLBARICON (NPPMSG + 41)
    //void WM_ADDTOOLBARICON(UINT func_item[X]._cmdID, toolbarIcons icon)
		struct toolbarIcons {
			HBITMAP	hToolbarBmp;
			HICON	hToolbarIcon;
		};
