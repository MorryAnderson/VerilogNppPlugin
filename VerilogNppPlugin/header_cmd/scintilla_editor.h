#ifndef SCINTILLA_EDITOR_H
#define SCINTILLA_EDITOR_H
...
typedef std::basic_string<char, std::char_traits<char>, std::allocator<char> >::size_type StrSizeType;
...
class ScintillaEditor final {
  ...
  public:
    ...
    void SetScintillaInstance(HWND scintilla) {
        ...
        directFunction = reinterpret_cast<SciFnDirect>(SendMessage(scintilla, SCI_GETDIRECTFUNCTION, 0, 0));
    ...
    std::string GetCurLine() const {
        ...
        std::string text(static_cast<StrSizeType>(static_cast<StrSizeType>(size + 1)), '\0');
    ...
    std::string StyleGetFont(int style) const {
        ...
        std::string fontName(static_cast<StrSizeType>(size + 1), '\0');
    ...
    std::string GetWordChars() const {
        ...
        std::string characters(static_cast<StrSizeType>(size + 1), '\0');
    ...
    std::string GetLine(int line) const {
        ...
        std::string text(static_cast<StrSizeType>(size + 1), '\0');
    ...
    std::string GetTag(int tagNumber) const {
        ...
        std::string tagValue(static_cast<StrSizeType>(size + 1), '\0');
    ...
    std::string TargetAsUTF8() const {
        ...
        std::string s(static_cast<StrSizeType>(size + 1), '\0');
    ...
    std::string EncodedFromUTF8(const std::string& utf8) const {
        ...
        std::string encoded(static_cast<StrSizeType>(size + 1), '\0');
    ...
    std::string MarginGetStyles(int line) const {
        ...
        std::string styles(static_cast<StrSizeType>(size + 1), '\0');
    ...
    std::string GetRepresentation(const std::string& encodedCharacter) const {
        ...
        std::string representation(static_cast<StrSizeType>(size + 1), '\0');
    ...
    std::string GetProperty(const std::string& key) const {
        ...
        std::string value(static_cast<StrSizeType>(size + 1), '\0');
    ...
    std::string GetLexerLanguage() const {
        ...
        std::string language(static_cast<StrSizeType>(size + 1), '\0');
    ...
    std::string PropertyNames() const {
        ...
        std::string names(static_cast<StrSizeType>(size + 1), '\0');
    ...
    std::string DescribeProperty(const std::string& name) const {
        ...
        std::string description(static_cast<StrSizeType>(size + 1), '\0');
    ...
    std::string DescribeKeyWordSets() const {
        ...
        std::string descriptions(static_cast<StrSizeType>(size + 1), '\0');
    ...
    std::string NameOfStyle(int style) const {
        ...
        std::string name(static_cast<StrSizeType>(size + 1), '\0');
    ...
    std::string TagsOfStyle(int style) const {
        ...
        std::string tags(static_cast<StrSizeType>(size + 1), '\0');
